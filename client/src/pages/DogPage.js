...
function DogPage(){
    ...
    return (
        <div className="dog-page-container">
            <h1>Adopt {dogInfo['name']}</h1>
            <div className="dog-page-card">
                <div className="dog-page-image-container">
                    <img src={dogInfo['image']} alt={dogInfo['breed']} className="dog-page-image" />
                </div>
                <h3 className="dog-page-name">{dogInfo['name']}</h3>
                <h3 className={`dog-page-status ${dogInfo['isAdopted'] ? 'adopted' : 'available'}`}>
                    {dogInfo['isAdopted'] ? "Adopted" : "Available for Adoption"}
                </h3>
                ...
                <p className="dog-page-description">
